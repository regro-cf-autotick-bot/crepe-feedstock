...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/crepe-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9780&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/crepe-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `crepe` can be installed with:

```
conda install crepe
```

It is possible to list all of the versions of `crepe` available on your platform with:
